...
import { getPhotosForPoint } from '../utils/photoUtils';
...
const PointDetailScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    // Автоматически отмечаем точку как посещённую
        ...
        <View style={styles.section}>
          ...
          <View style={styles.mediaRow}>
            <TouchableOpacity 
              ...
              onPress={() => navigation.navigate('PointGallery', { pointId: point.id })}
            >
              <FontAwesome5 name="images" size={24} color="#4B0082" />
              <Text style={styles.mediaText}>Фото ({photoCount})</Text>
            </TouchableOpacity>
